...
## 9. 对客最新复核规范同步（rules.json v1.2）

相对 V1.1，附件决策表带来的关键口径更新已写入 `knowledge/latest_decision_table.md` 与 `rules.json`：

| 变更 | 口径 |
|---|---|
| AB贷 | 由贷款相关高风险违规 **升级为涉诈**（`贷款相关-AB贷`） |
| 引导用户添加私人微信 | **新增涉诈**：平台核资后引导加下款/放款经理私人微信 |
| 路费诈骗 | **新增涉诈**：招聘+仓库/路线+入职注册费 |
| 企业营销细分 | 代开发票/注册注销年报代办收费=中风险；培训提前收费=低风险；纯人工获客=合规 |
